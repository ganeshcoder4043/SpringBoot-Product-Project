...
import com.springbootproject.product.dto.ExceptionResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleCategoryNotFoundException(CategoryNotFoundException ex,WebRequest webRequest){
        ExceptionResponseDTO exceptionResponseDTO = new ExceptionResponseDTO(
                webRequest.getDescription(false),
